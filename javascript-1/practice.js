...
let total = myNumbers.reduce(function(acc, e){
	return acc + e
}, 0)
...
let forTheLoveOfGeorge = notGeorge.map(function(e){
	return (e === 'George') ? false : 'George'
})
...
let totallyAwesome = people.reduce(function(acc, e){
